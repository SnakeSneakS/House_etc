...
function createMaterialVideo(numV,url){ 
    ...
    /*document.getElementById("movies").appendChild(videoes[numV]);
...
//外部からhtml取得。その後canvasの中身をそのhtmlのdiv[0]に
function GetHTML_SetCanvas(url,numHTML,numP,numDiv){//HTMLs[numHTML]に格納
	...
	xhr.onreadystatechange = function () {
		if(xhr.readyState === 4 && xhr.status === 200) {
            ...
            CanvasSetHTML(HTMLs[numHTML].getElementsByTagName("div")[numDiv],numP)
